<template>
	<div class="querytable">
		...
		<el-row :gutter="0" >
			...
			<el-col :span="12">
				<div class="headtit">从表格</div>
				<kt-table permsEdit="sys:user:edit"  :showOperation="showOperation" :showAdd="showAdd" 
					:showEdit="showEdit"  :showDelete="showDelete" :showLineOpt="showLineOpt"
					:data="pageResult" :columns="filterColumns" ref="tblts" @handleAdd="handleAdd"  
					@findPage="findPage" @handleEdit="handleEdit" @handleDelete="handleDelete">
				</kt-table>			
			</el-col>
		</el-row>
